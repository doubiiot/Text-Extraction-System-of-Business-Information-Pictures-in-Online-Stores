...
def horizontal_split_chinese_3(src, limit_color, limit_number, store, show, scope, horizontal_id):
    #腐蚀图像
...
def horizontal_split_char_3(src, limit_color, limit_number, store, show, horizontal_id):
    ...
    min_width = int(src.shape[0] * 0.15)        #最小宽度
        ...
        # 进入空白区
            ...
            if width > min_width:
                if width > max_width:
                    ...
                    column_image = src[0: src.shape[0], char_index - 1: blank_index + 2]
                    column_list.append(column_image)
